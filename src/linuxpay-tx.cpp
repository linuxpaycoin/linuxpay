...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Linuxpay Core linuxpay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  linuxpay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded linuxpay transaction") + "\n" +
                               "  linuxpay-tx [options] -create [commands]   " + _("Create hex-encoded linuxpay transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded linuxpay transaction
