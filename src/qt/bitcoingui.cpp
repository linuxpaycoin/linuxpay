                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Linuxpay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Linuxpay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and linuxpay: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLNP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Linuxpay Core"), this);
    aboutAction->setStatusTip(tr("Show information about Linuxpay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Linuxpay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Linuxpay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Linuxpay addresses"));
    ...
    openAction->setStatusTip(tr("Open a Linuxpay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Linuxpay Core help message to get a list with possible Linuxpay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Linuxpay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Linuxpay network", "", count));
}
...
{
    QString strTitle = tr("Linuxpay Core"); // default title
