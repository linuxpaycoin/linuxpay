...
public:
    ...
    void setZLNPControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzLNP_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzLNP_clicked();
    void on_pushButtonZLNPControl_clicked();
