...
/** Utility functions used by the Linuxpay Qt UI.
 */
namespace GUIUtil
{
...
// Render Linuxpay addresses in monospace font
...
// Parse "linuxpay:" URI into recipient object, return true on successful parsing
