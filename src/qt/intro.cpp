...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Linuxpay Core"),
     ...
     * override -datadir in the linuxpay.conf file in the default data directory
     * (to be consistent with linuxpayd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
