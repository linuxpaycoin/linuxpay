...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Linuxpay is not connected
    ...
    RPC_WALLET_PASSLNPASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
