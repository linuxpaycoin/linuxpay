...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Linuxpay server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Linuxpay server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Linuxpay features */
        {"linuxpay", "masternode", &masternode, true, true, false},
        {"linuxpay", "listmasternodes", &listmasternodes, true, true, false},
        {"linuxpay", "getmasternodecount", &getmasternodecount, true, true, false},
        {"linuxpay", "masternodeconnect", &masternodeconnect, true, true, false},
        {"linuxpay", "masternodecurrent", &masternodecurrent, true, true, false},
        {"linuxpay", "masternodedebug", &masternodedebug, true, true, false},
        {"linuxpay", "startmasternode", &startmasternode, true, true, false},
        {"linuxpay", "createmasternodekey", &createmasternodekey, true, true, false},
        {"linuxpay", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"linuxpay", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"linuxpay", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"linuxpay", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"linuxpay", "getmasternodescores", &getmasternodescores, true, true, false},
        {"linuxpay", "mnbudget", &mnbudget, true, true, false},
        {"linuxpay", "preparebudget", &preparebudget, true, true, false},
        {"linuxpay", "submitbudget", &submitbudget, true, true, false},
        {"linuxpay", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"linuxpay", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"linuxpay", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"linuxpay", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"linuxpay", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"linuxpay", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"linuxpay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"linuxpay", "checkbudgets", &checkbudgets, true, true, false},
        {"linuxpay", "mnsync", &mnsync, true, true, false},
        {"linuxpay", "spork", &spork, true, true, false},
        {"linuxpay", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"linuxpay", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use linuxpayd, or the -server option to linuxpay-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> linuxpay-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1116/\n";
}
