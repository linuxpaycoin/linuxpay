Contributing to Linuxpay Core
============================

The Linuxpay Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Linuxpay Core project, and is not to be
confused with overall Linuxpay Network Protocol consensus changes.

Whether a pull request is merged into Linuxpay Core rests with the project merge
...
Patches that change Linuxpay consensus rules are considerably more involved than
...
Where a patch set proposes to change the Linuxpay consensus, it must have been
...
The project leader is the release manager for each Linuxpay Core release.
