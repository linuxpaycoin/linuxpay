...
In order to support loading of multiple wallets in linuxpay-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is linuxpay.cpp.
...
Changes to linuxpay.cpp
----------------------
linuxpay.cpp is the entry point into linuxpay-qt, and as such, will require some minor modifications to provide hooks for
