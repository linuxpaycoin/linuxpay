...
cp $TRAVIS_BUILD_DIR/src/qt/linuxpay-qt $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/qt/linuxpay-qt.exe $OUTDIR/bin/ || echo "no QT Wallet"
cp $TRAVIS_BUILD_DIR/src/linuxpayd $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/linuxpayd.exe $OUTDIR/bin/
cp $TRAVIS_BUILD_DIR/src/linuxpay-cli $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/linuxpay-cli.exe $OUTDIR/bin/
