...
RESOURCES += src/qt/linuxpay.qrc src/qt/linuxpay_locale.qrc

TRANSLATIONS += src/qt/locale/linuxpay_bg.ts \
                src/qt/locale/linuxpay_de.ts \
                src/qt/locale/linuxpay_en.ts \
                src/qt/locale/linuxpay_es.ts \
                src/qt/locale/linuxpay_fi.ts \
                src/qt/locale/linuxpay_fr.ts \
                src/qt/locale/linuxpay_it.ts \
                src/qt/locale/linuxpay_ja.ts \
                src/qt/locale/linuxpay_pl.ts \
                src/qt/locale/linuxpay_pt.ts \
                src/qt/locale/linuxpay_ru.ts \
                src/qt/locale/linuxpay_sk.ts \
                src/qt/locale/linuxpay_sv.ts \
                src/qt/locale/linuxpay_vi.ts \
                src/qt/locale/linuxpay_zh_CN.ts \
                src/qt/locale/linuxpay_zh_TW.ts
